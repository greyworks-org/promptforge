...
- **Current phase:** Phase 3 complete — project onboarding & `.promptforge` bootstrap.
- **Last validated task:** Phase 3 closing (2026-08-07) — runtime smoke verification passed; all automated gates green.
- **Current task:** none.
- **Next task:** Phase 4 — context pipeline (registry, FTS5 search, selection, budgets).
